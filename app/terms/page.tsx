      ...
      <Container maxWidth="md">
        <Box sx={{ py: 4 }}>
          ...
          <Paper sx={{ p: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              This service provides a comprehensive Next.js application boilerplate with authentication, user
              management, and modern web development features. The service is provided &quot;as is&quot; for educational
            ...
            <Typography variant="body1" paragraph>
              ...
              overburden, or impair the service. You also agree not to attempt to gain unauthorized access to any part
              of the service.
            </Typography>
            ...
            <Typography variant="body1" paragraph>
              ...
              posting. Your continued use of the service after any changes constitutes acceptance of the new terms.
            </Typography>
