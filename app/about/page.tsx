...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Calculated Structura - A modern Next.js boilerplate application',
}
      ...
      <Container maxWidth="lg">
        <Box sx={{ py: 4 }}>
          ...
          <Typography variant="h6" align="center" color="text.secondary" sx={{ mb: 6 }}>
            A comprehensive Structura for modern web applications
          </Typography>
            ...
            <Grid size={{ xs: 12, md: 8 }}>
              <Paper sx={{ p: 4, mb: 4 }}>
                ...
                <Typography variant="body1" sx={{ mb: 2 }}>
                  ...
                  applications. It combines the latest technologies and best practices to provide developers with a
                  robust starting point for their projects.
                </Typography>
                <Typography variant="body1" sx={{ mb: 2 }}>
            ...
            <Grid container spacing={3} sx={{ mt: 2 }}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <Box sx={{ textAlign: 'center', p: 2 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Error monitoring and performance tracking helping us deliver a reliable and bug-free user
                    experience.
                  </Typography>
                </Box>
              </Grid>
